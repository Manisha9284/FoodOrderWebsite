    ...
    <div class="main-content">
        ...
        <?php
            ...
            if(isset($_GET['id']))
            {
                ...
                // Check whether th data is available or not
                if($count==1)
                {
                    // Get the data
        ...
        <?php
            if(isset($_POST['submit']))
            {
                ...
                // 1.Get the values from our form
                $title=$_POST['title'];
                $id=$_POST['id'];
                ...
                // 2.Updatting new image if selected
                ...
                if(isset($_FILES['image']['name']))
                {
                    ...
                    {
                        // If image is not available then let it be as current image
